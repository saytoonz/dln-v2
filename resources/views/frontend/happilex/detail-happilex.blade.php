...
@section('title')
    ...
    <meta property="og:url" content="{{ url('view-happilex') }}/{{ $data->slug }}" />
    <meta property="og:title" content="{{ $data->title }}" />
    <meta property="og:description" content="{{ $data->title }}" />
    <meta property="og:keywords" content="{{ $data->title }}" />
    <meta property="og:image" content="{{ url('happilexes') }}/{{ $data->image }}" />
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('happilexes') }}/{{ $data->image }}">
@endsection
@section('content')
    <div id="fb-root"></div>
