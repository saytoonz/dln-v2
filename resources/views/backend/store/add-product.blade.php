...
@section('content')
    ...
    <section class="section-container">
        ...
        <div class="content-wrapper">
            <div class="content-heading">Add Store Product</div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="mb-3 form-control form-control-lg" type="text" id="heading"
                                        placeholder="Product name..." name="title" onkeyup="generateSlug()" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="text" name="price" placeholder="Product price in GHS" class="form-control">
                                </div>


                                <div class="form-group">
                                    <label>Short Description</label>
                                    <textarea name="bio"   rows="5" placeholder="Bio" class="form-control"></textarea>
                                    <br>
                                    <div class="clearfix">
